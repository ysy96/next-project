  ...
  return (
    <div className="product-description-tab space-pt--r100 space-mt--r100 border-top--grey">
      <Tab.Container defaultActiveKey="description">
        ...
        >
          <Nav.Item>
            <Nav.Link eventKey="description">Product Info</Nav.Link>
          </Nav.Item>
          <Nav.Item>
          ...
          <Nav.Item>
            <Nav.Link eventKey="reviews">
              Ratings {product.ratingCount ? `(${product.ratingCount})` : ""}
            </Nav.Link>
          </Nav.Item>
        </Nav>
        <Tab.Content>
          ...
          <Tab.Pane eventKey="reviews">
            <div className="product-description-tab__review">
              ...
              {/*=======  End of single review  =======*/}
              <h2 className="review-title space-mb--20">Leave your comment!!</h2>
              <p className="text-center">
                Your email will not be published, don't worry. Fields marked with an * are required.
              </p>
              {/*=======  review form  =======*/}
